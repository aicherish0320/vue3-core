(function (global, factory) {
  ...
  const hasChanged$1 = (value, oldValue) => value !== oldValue;
      ...
      const effect = function () {
          if (!effectStack.includes(effect)) {
              try {
                  ...
                  effectStack.push(activeEffect$1);
                  return fn();
              }
              catch (error) {
              }
                  ...
                  effectStack.pop();
                  activeEffect$1 = effectStack[effectStack.length - 1];
              }
          }
      };
      effect.id = uid++;
  ...
  function track$1(target, key) {
      ...
      if (!dep.has(activeEffect$1)) {
          ...
          activeEffect$1.deps.push(key);
      }
  }
  function trigger$1(target, type, key, value, oldValue) {
      ...
      if (key === 'length' && isArray$1(target)) {
  ...
  function createSetter$1() {
      return function set(target, key, value, receiver) {
          ...
          // 数组新增、对象新增
          const hadKey = isArray$1(target) && isInteger(key)
  ...
  const get$2 = createGetter$1();
  const set$2 = createSetter$1();
  ...
  function reactive$1(target) {
      ...
      return createReactiveObject$1(target, mutableHandlers$1);
  }
  const proxyMap = new WeakMap();
  function createReactiveObject$1(target, baseHandlers) {
